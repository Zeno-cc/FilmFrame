...
function resetSchedule(){const from=new Date(Math.ceil(Date.now()/60000)*60000),by=new Date(from.getTime()+7*24*60*60*1000);byId("redeem-from").value=localInputValue(from);byId("redeem-by").value=localInputValue(by);updateScheduleSummary()}
